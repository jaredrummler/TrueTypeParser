...
public class GlyphProcessingState {
   ...
   *
   * @param gi
   *     glyph index that may be used to determine which match set applies
   ...
   * @param ignoreTester
   *     glyph tester to use to determine which glyphs are ignored (or null, in which case none are ignored)
   * @param glyphs
   ...
   *     true if to obtain in reverse order
   * @param ignoreTester
   *     glyph tester to use to determine which glyphs to count (or null, in which case none are ignored)
   ...
   *     from current position
   * @param count
   *     number of glyphs to replace, which, if negative means all glyphs from offset to end of input sequence
   * @param gs
   *     glyph sequence from which to obtain replacement glyphs
   * @param gsOffset
   *     offset of first glyph in replacement sequence
   * @param gsCount
   *     count of glyphs in replacement sequence starting at <code>gsOffset</code>
