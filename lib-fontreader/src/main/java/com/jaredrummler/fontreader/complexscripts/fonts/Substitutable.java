...
public interface Substitutable {
   ...
   *
   * @param cs
   *     character sequence to map to output font encoding character sequence
   * @param script
   *     a script identifier
   * @param language
   *     a language identifier
   * @param associations
   *     optional list to receive list of character associations
   * @param retainControls
   ...
   *
   * @param cs
   *     character sequence within which combining marks to be reordered
   * @param gpa
